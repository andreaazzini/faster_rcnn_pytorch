...
def test():
    import os
    im_file = '/home/ubuntu/7.jpg'
    # im_file = '/datasets/OpenImages/VOCify/JPEGImages/7b7046209fb3b9a0.jpg'
    ...
    model_file = 'models/openimages/faster_rcnn_50000.h5'
    # model_file = '/datasets/VGGnet_fast_rcnn_iter_70000.h5'
